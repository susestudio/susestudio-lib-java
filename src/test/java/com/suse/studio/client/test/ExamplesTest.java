...
public class ExamplesTest {
	...
	public void testAccount() {
		User user = TestUtils.getTestResource(User.class, "account.xml");
		assertNotNull(user);
	...
	public void testAppliances() {
		Appliances appliances = TestUtils.getTestResource(Appliances.class,
				"appliances.xml");
	...
	public void testAppliance() {
		Appliance appliance = TestUtils.getTestResource(Appliance.class,
				"appliance.xml");
	...
	public void testApplianceStatus() {
		Status status = TestUtils.getTestResource(Status.class,
	...
	public void testTemplateSets() {
		...
		TemplateSets templateSets = TestUtils.getTestResource(
